...
that accept parameters. assigninfill is a dictionary that should be formatted
...
#which accepts parameter 'minsplit' for minimyum character length of detected overlaps:
